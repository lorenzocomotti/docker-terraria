...
This repository contains the Dockerfile and associated assets for building a Terraria server 1.4.4.9 Docker image
...
```
sudo docker run -it -p 7777:7777 -v $HOME/terraria/worlds:/opt/terraria/worlds -v $HOME/terraria/configurations/serverconfig.txt:/opt/terraria/Linux/serverconfig.txt --name="terraria" lorenzocomotti/docker-terraria:1.4.4.9
```
